...
export default class Pins extends PureComponent {
  render() {
    ...
    return (
      <Marker longitude={3.3007} latitude={6.6193} style={{ zIndex: 40}}>
      <svg  height={SIZE}
      viewBox="0 0 512 512"
      style={{
        cursor: 'pointer',
